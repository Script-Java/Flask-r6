...
class R6tracker:
    ...
    def general_info(self):
        ...
        profile_views = profile_views_span.text.split()[0]
        ...
        if rp_banner_container is not None:
            rp_banner_el = rp_banner_container.find("div", {"style":"width: 50px; margin-right: 14px;"})
            rp_banner_img = rp_banner_el.find("img", recursive=False)
            rp_banner = rp_banner_img["src"]
        else:
            rp_banner = "https://trackercdn.com/cdn/r6.tracker.network/ranks/s23/small/unranked.png"
